...
function calcularProfit(precioEntrada, apalancamiento, cantidad, precioSalida) {
     ...
     const dif = precioSalida - precioEntrada;
     const profitUSDT = margenInicial * dif;
...
botonCalcular.addEventListener("click", function (e) {
     ...
     const { margenInicial, profitUSDT, profitPorcentaje } = calcularProfit(precioEntrada, apalancamiento, cantidad, precioSalida);
